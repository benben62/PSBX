---
title: "Le travail de Jean Souris **[est disponible ici](https://github.com/jeansouris/PSBX/blob/main/gr03_souris_jean_pracma.pdf)**"
...
Ce package fournit des fonctions plus avancées en analyse numérique, avec une vue spéciale sur l'optimisation et les routines de séries chronologiques. Jean a reussi a bien explique les fonctionnalites de pracma et n'a pas hesite a commente clairement chaque ligne de son code afin de faciliter la lecture. 
...
Critère 2 : Originalite du code        3/4 Jean a bien montre comment utiliser les differentes fonctions avec une demarche                                            adequate.   

Critère 3 : Fonctionnalité du code     4/4 le code fonctionn bien. 
...
Globalement un tres bon travail qui exlique tres bien pracma, pas de necessite de rajouter des commentaires. Jean a su se montrer pedagogue dans sa demarche d'explication. 